...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL','-1002053183241'))

#ai
OPENAI_API = environ.get("OPENAI_API","")
AI = is_enabled((environ.get("AI","True")), False)
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001585443746")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
